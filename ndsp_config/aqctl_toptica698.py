#!/usr/bin/env python3
"""
Toptica DLC Pro NDSP Controller for ARTIQ.
...
Usage:
    python3 aqctl_toptica.py -p 3285 --bind ::1 --ip 192.168.1.50

Then in ARTIQ experiments:
    self.toptica698.get_current()
    self.toptica698.get_temperature()
"""
...
def get_argparser():
    parser = argparse.ArgumentParser(
        description="ARTIQ NDSP controller for Toptica DLC Pro laser"
    )
...
def main():
    ...
    logger.info("Starting Toptica DLC Pro controller...")
